import { Box, Grid, IconButton, Typography, Chip, Divider, Button , Skeleton } from '@mui/material';
            ...
            <Box sx={{ backgroundColor: DASH.canvas, px: 2, py: 1.2, borderBottom: `1px solid ${DASH.line}` }}>
                <Grid container alignItems="center">
                    <Grid size={{ xs: 12, sm: 6 }} sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        ...
                        <Box>
                            <Typography sx={{ fontWeight: 700, fontSize: '20px', color: DASH.ink, lineHeight: 1.2 }}>Subject Management</Typography>
                            <Typography sx={{ fontSize: '11.5px', color: DASH.muted, whiteSpace: 'nowrap' }}>Maintain the subject list and map it onto each class</Typography>
                        </Box>
                    </Grid>
