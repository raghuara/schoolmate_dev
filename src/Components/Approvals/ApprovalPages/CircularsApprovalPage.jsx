...
export default function CircularsApprovalPage() {
    ...
    const visibleCirculars = scheduleData.filter(
            ...
            <Box ref={boxRef} sx={{ flex: 1, minHeight: 0, overflowY: "auto" }}>
                <Box sx={{ p: 2 }}>
                    ...
                    {visibleCirculars.length > 0 &&
                        <SectionBand label="Scheduled Circulars" accent={DASH.violet} />
                    }
                    {visibleCirculars.length > 0 &&
                        scheduleData
                    ...
                    {statusData.length > 0 && (
                        <SectionBand label="Circulars awaiting approval" accent="#7DC353" />
                    )}
                    {statusData.length > 0 ? (
                        statusData
                            .filter((statusItem) => rollNumber !== statusItem.createdByRollNumber)
