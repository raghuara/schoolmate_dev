import { Autocomplete, Box, Button, DialogActions, Dialog, Fab, IconButton, Paper, Switch, TextField, Typography, ToggleButton, ToggleButtonGroup, Grid, styled } from "@mui/material";
                ...
                <Box sx={{ p: 2 }}>
                    ...
                    {view === 'grid' ? (
                        ...
                        <Grid container spacing={1.5}>
                            {!hasLoaded ? (
                                <PostedCardsSkeleton count={4} columns={{ xs: 12, sm: 12, md: 12, lg: 12 }} rows={2} />
                            ) : timeTableData.length > 0 ? (
                                timeTableData.map((table, index) => (
                                    <React.Fragment>
                                        {/* Render the date */}
