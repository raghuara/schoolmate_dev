...
export default function AssetsPage() {
    ...
    const items = [
        { color: "#A749CC", icon: AirportShuttleIcon, text: "Transport Asset", bgColor: "#FBF9FC", iconBgColor: "#F7F0F9", path: 'transport', intimation: newsIntimation },
            ...
            <Box sx={{ backgroundColor: "#f2f2f2", p: 1.5, borderRadius: "10px 10px 10px 0px", borderBottom: "1px solid #ddd", }}>
                <Grid container sx={{ width: "100%" }}>
                    <Grid
                        ...
                        <Typography sx={{ fontWeight: "600", fontSize: "20px", ml: 2 }} >Assets</Typography>
                    </Grid>
                    <Grid
