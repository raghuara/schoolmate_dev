...
import { getVehicleDetailById, postVehicle, updateVehicleDetails } from '../../../../Api/Api'
...
export default function EditVehicleDetails() {
    ...
    const getUsers = async () => {
        ...
        try {
            ...
            setBusName(details.busInternalName || "")
            setVehicleType(details.vehicleType || null)
            setVehicleBrand(details.vehicleBrand || "")
            setRegistrationNumber(details.registrationNumber || "")
            setTotalSeats(details.totalSeatsCount || 0)
            setManufacturingYear(details.manufacturingYear || 0)
            setFuelType(details.fuel || null)
        } catch (error) {
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            const res = await axios.put(updateVehicleDetails, sendData, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
            ...
            <Box sx={{ p: 2, }}>
                <Box sx={{ position: "relative", backgroundColor: "#FFF", border: "1px solid #ccc", }}>
                    ...
                    <Box sx={{ position: "absolute", bottom: "10px", right: "10px", }}>
                        ...
                        <Button onClick={handleUpdate} sx={{ textTransform: "none", color: "#000", py: 0.2, px: 2.5, fontSize: "12px", borderRadius: "20px", backgroundColor: websiteSettings.mainColor }}>
                            Update
                        </Button>
