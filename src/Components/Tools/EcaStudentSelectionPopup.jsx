                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                    ...
                    <Box>
                        ...
                        <Typography sx={{ fontSize: 12, color: 'rgba(255,255,255,0.8)', mt: 0.3 }}>
                            Search and select students by roll number
                        </Typography>
                    </Box>
                </Box>
                <IconButton
                        ...
                        <Box sx={{
                            ...
                            <Box sx={{ p: 2, backgroundColor: '#fff' }}>
                                <TextareaAutosize
                                    ...
                                    onFocus={(e) => {
                                        e.target.style.borderColor = ECA_COLOR;
                            ...
                            {suggestions.map((user, i) => (
                                ...
                                >
                                    <Typography sx={{ fontSize: 13 }}>
                                        <Box component="span" sx={{ fontWeight: 600, color: ECA_COLOR }}>
                                            {user.rollNumber}
                                        </Box>
                                        {' '}— {user.name}
                                    </Typography>
