...
export default function DraftPage() {
    ...
    const items1 = [
        { color: "#A749CC", icon: SchoolIcon, text: "School Fee", bgColor: "#FBF9FC", iconBgColor: "#F7F0F9", path: 'news'},
        { color: "#ED9146", icon: DirectionsBusIcon, text: "Transport Fee", bgColor: "#FCFBF9", iconBgColor: "#FBF4EF", path: 'messages', },
        { color: "#7DC353", icon: SportsSoccerIcon, text: "Extracurricular Activity Fee", bgColor: "#F9FBF7", iconBgColor: "#F2F8EE", path: 'circulars' },
            ...
            <Box sx={{ backgroundColor: "#f2f2f2", px: 1.5, py: 0.9, borderRadius: "10px 10px 10px 0px", borderBottom: "1px solid #ddd", }}>
                <Grid container sx={{ width: "100%" }}>
                    <Grid
                        ...
                        <Typography sx={{ fontWeight: "600", fontSize: "20px", }} >Draft</Typography>
                    </Grid>
                </Grid>
            </Box>
            <Box>
