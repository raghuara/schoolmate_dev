        ...
        <Grid container>
          <Grid size={{ xs: 12, sm: 12, md: 6, lg: 6 }} sx={{ display: "flex", alignItems: "center", py: 1.5 }}>
            ...
            <Box>
                            ...
                            <Typography sx={{ fontSize: "11.5px", color: DASH.muted, mt: 0.2 }}>Track the activity fees you sent for approval</Typography>
                        </Box>
          </Grid>
          <Grid
              ...
              details.map((item) => (
                <Grid key={item} size={{ lg: 12, md: 8, }} sx={{pt:2}}>
                  ...
                  <Box p={2} sx={{ backgroundColor: "#fff", border: `1px solid ${DASH.line}`, borderRadius: "5px" }}>
                    ...
                    {item.paid === "Y" &&
                      <Box sx={{ backgroundColor: "#FFE5E5", p: 3, border: `1px solid ${DASH.line}`, borderTop: "none", }}>
