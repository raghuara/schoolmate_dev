...
import { additionalFeeFetch, approvalStatusCheck, approvalStatusCheckAdditional, deleteAdditionalFeesStructure, deleteSchoolFeesStructure } from "../../../../Api/Api";
...
export default function AdditionalFeeApprovalStatus() {
            ...
            <Box sx={{ mb: 2 }}>
                <Grid container>
                    <Grid size={{ xs: 12, sm: 12, md: 6, lg: 6 }} sx={{ display: "flex", alignItems: "center", py: 1.5 }}>
                        ...
                        <Box>
                            <Typography sx={{ fontSize: "20px", fontWeight: 700, color: DASH.ink, lineHeight: 1.2 }}>Additional Fee Approval Status</Typography>
                            <Typography sx={{ fontSize: "11.5px", color: DASH.muted, mt: 0.2 }}>Track the one-off charges you sent for approval</Typography>
                        </Box>
                    </Grid>
                    <Grid
                                            ...
                                            >
                                                ...
                                                <DialogContent sx={{ px: 2.5, py: 2.5 }}>
                                                    <Box sx={{ display: "flex", flexDirection: "column", gap: 0 }}>
                                                        ...
                                                        {/* Approved / Declined — hidden if same person created and approved */}
                                                        {(item.approvedBy || item.approvedOnDate) && item.approvedBy !== item.createdBy && (() => {
