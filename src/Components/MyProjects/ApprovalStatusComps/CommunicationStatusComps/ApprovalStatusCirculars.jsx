...
export default function ApprovalStatusCircularsPage() {
    ...
    /*
       ...
       circulars, and your circulars actually goes for approval.
    ...
    */
    const canTrackThis = !rbacReady || !matrixReady
        || (findSubMenuPermissions(user?.permissions, "communication", "circular")?.create === "Y"
    ...
    return (
        ...
        >
            ...
            <PageHeader
                title="Circulars Approval Status"
                subtitle="Circulars you sent for approval and where each one stands"
            ...
            >
                ...
                >
                    <TextField
                        placeholder="Search circulars by heading"
                        value={searchQuery}
                    ...
                    {filteredStatusData.length > 0 ? (
                        <Grid container spacing={2}>
                            {filteredStatusData.map((statusItem) => {
                                ...
                                return (
                                    <Grid key={statusItem.id} size={{ xs: 12, sm: 12, lg: 12 }}>
                                        <>
                        ...
                        >
                            ...
                            <Typography sx={{ fontSize: "12.5px", color: DASH.faint }}>
                                {searchQuery ? "No circulars match your search." : "Nothing sent for approval yet."}
                            </Typography>
                        </Box>
